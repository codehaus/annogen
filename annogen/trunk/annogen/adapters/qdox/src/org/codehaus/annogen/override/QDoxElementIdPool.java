...
public interface QDoxElementIdPool {
  ...
  public static class Factory {
    public static QDoxElementIdPool create(JamLogger logger) {
  ...
  public ElementId getIdFor(AbstractJavaEntity qdoxElement);

  public ElementId getIdFor(JavaParameter qdoxParameter);
